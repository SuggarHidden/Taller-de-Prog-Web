  ...
  <div class="crypto-section">
    ...
    <section id="bitcoin">
      <section class="info-section">
        ...
        <section class="crypto-info">
          <p>Bitcoin es la primera criptomoneda creada y es conocida como el oro digital.
            Es una moneda descentralizada y utiliza la tecnología blockchain para asegurar y verificar transacciones.
          </p>
        </section>
      </section>
      <section class="crypto-stats">
    ...
    <section id="litecoin">
      <section class="info-section">
        ...
        <section class="crypto-info">
          <p>Litecoin es una criptomoneda que fue creada como una versión más ligera de Bitcoin.
            Se caracteriza por tener tiempos de confirmación más rápidos y una eficiencia de almacenamiento mejorada.
          </p>
        </section>
      </section>
      <section class="crypto-stats">
    ...
    <section id="dogecoin">
      <section class="info-section">
        ...
        <section class="crypto-info">
          <p>Dogecoin es una criptomoneda basada en el popular meme "Doge". Aunque empezó como una broma,
            ha ganado una gran comunidad y es utilizada principalmente para propinas y donaciones.</p>
        </section>
      </section>
      <section class="crypto-stats">
        <table>
    ...
    <section id="usdt">
      <section class="info-section">
        ...
        <section class="crypto-info">
          <p>Tether (USDT) es una criptomoneda stablecoin que está vinculada al valor del dólar estadounidense. Está
            diseñada para mantener un valor estable y
            es utilizada frecuentemente en transacciones y como refugio durante la volatilidad del mercado.</p>
        </section>
      </section>
      <section class="crypto-stats">
        <table>
